...
export default function LeandroPage() {
  return (
    <div className="flex flex-col bg-cedro-white text-cedro-ink">
      <section className="min-h-svh flex items-center pt-32 pb-16 bg-[#f8f4ec]">
        <div className="max-w-[1200px] mx-auto px-5 md:px-8 w-full">
          <div className="grid grid-cols-1 md:grid-cols-[1fr_1.5fr] gap-16 items-start">
            ...
            >
              <div className="relative inline-block max-w-[400px] w-full">
                ...
                <Image 
                  ...
                  alt="Leandro Carone" 
                  className="w-full h-auto object-cover object-top rounded-lg shadow-[0_24px_60px_rgba(37,42,58,0.14)]"
                  width={480}
                  height={600}
                  priority
            ...
            >
              ...
              <h1 className="mb-2 text-cedro-navy">Leandro Carone</h1>
              <p className="font-serif italic text-3xl md:text-4xl text-cedro-ink/70 mb-6">Psicólogo, logoterapeuta, supervisor clínico e fundador da Clínica Cedro.</p>
              <a
                href="https://form.respondi.app/rdiSvqJY"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-sm text-cedro-red font-medium hover:text-cedro-red-hover transition-colors mb-8"
              >
                Quero fazer supervisão com o Leandro →
              </a>
              <Divider />
              <div className="flex flex-col gap-5 text-cedro-ink/76">
      ...
      <section className="py-24 bg-cedro-white text-cedro-ink">
        <div className="max-w-[800px] mx-auto px-5 md:px-8">
          <h3 className="text-cedro-navy mb-6">O encaixe</h3>
          <p className="mb-5 text-cedro-ink/78">Foi na psicologia de Viktor Frankl que encontrei o primeiro elo. A Logoterapia opera sobre uma ontologia dimensional: o ser humano é corpo, psiquismo e espírito. Isso abria espaço legítimo para a espiritualidade dentro de um modelo clínico rigoroso, sem misticismo e sem reducionismo.</p>
          <p className="mb-5 text-cedro-ink/78">O segundo elo foi ter feito terapia com o Jota Borgonhoni, ali encontrei uma pessoa, não só um psicólogo. E ele me mostrou que era possível atender de verdade, sem fingimentos, com técnica, autenticidade e bom senso. O considero como meu padrinho da profissão.</p>
          <p className="mb-5 text-cedro-ink/78">Quando somei a isso a descrição das 12 camadas da personalidade aprendida com Francisco Escorsim e os trabalhos de Eric Johnson, Larry Crabb e Paul Tournier sobre integração entre teologia e psicologia, a síntese se formou. Cada tema que trato passa pelo mesmo filtro: como isso afeta o mundo físico, o comportamento concreto? Como afeta a subjetividade, a emoção, a narrativa, a experiência interna? E como afeta o espiritual, a relação com Deus, com o sentido, responsabilidade, com a identidade? Quando as três dimensões são contempladas entendo que a resposta é completa.</p>

          <div className="p-8 md:p-12 border-l-4 border-cedro-red my-12 bg-[#f8f4ec] rounded-r-lg">
            <p className="font-serif text-4xl md:text-5xl italic text-cedro-navy">&quot;Encontrei ali um caminho para a minha própria maturidade, para lidar com as minhas falhas de uma maneira coerente com a realidade, não com uma versão editada dela.&quot;</p>
          </div>

          <h3 className="text-cedro-navy mb-6">O início</h3>
          <p className="mb-5 text-cedro-ink/78">Comecei a trabalhar como psicólogo em 2020 com uma obsessão: dominar o ofício. No primeiro ano, cheguei a atender 10, 12 pacientes por dia boa parte deles de graça porque eu precisava verificar na prática se o que eu estudava realmente transformava vidas.</p>
          <p className="mb-5 text-cedro-ink/78">Cursos, supervisão, livros, pós-graduação em análise existencial e Logoterapia com o professor Luís Enrique, prática clínica orientada pelo Jota Borgonhoni. Fui atrás de tudo que daria robustez prática e teórica ao meu trabalho. Eu sabia que lidar com a vida de um paciente exige preparo, não apenas boa intenção.</p>

          <h3 className="text-cedro-navy mb-6 mt-12">A perseguição</h3>
          <p className="mb-5 text-cedro-ink/78">Quando decidi me posicionar publicamente como psicólogo cristão, em 2023, eu sabia o custo. Mas não fiz por nicho mercadológico, fiz por vocação. Via a demanda real dos meus irmãos: pais procurando profissionais que não conduzissem seus filhos por um caminho oposto aos seus valores. Casamentos destruídos por orientações clínicas fundadas numa cosmovisão hedonista e materialista travestida de neutralidade. Homens presos em ciclos viciosos de pornografia encontrando profissionais normalizando o absurdo.</p>
          <p className="mb-5 text-cedro-ink/78">Em menos de um ano o conselho de psicologia me procurou a partir de denúncias anônimas, não pela minha conduta clínica, mas por posts do meu perfil. Pelas minhas opiniões. Pela minha fé.</p>
          <p className="mb-5 text-cedro-ink/78">Cogitei recuar. Estava com menos de 4 mil seguidores, apertado financeiramente, com minha esposa grávida. Mas quando li o Salmo 18, tive clareza. Contratei um advogado com um dinheiro que eu não tinha e montei o caso.</p>

          <div className="p-8 md:p-12 border-l-4 border-cedro-red my-12 bg-[#f8f4ec] rounded-r-lg">
            <p className="font-serif text-4xl md:text-5xl italic text-cedro-navy">&quot;Bem-aventurados os perseguidos por causa da justiça, porque deles é o Reino dos Céus.&quot;</p>
            <cite className="block mt-4 font-sans not-italic text-sm text-cedro-ink/60">Mateus 5:10</cite>
          </div>

          <p className="mb-5 text-cedro-ink/78">O processo segue em andamento, defendido com base na liberdade religiosa. Eu não recuei.</p>

          <h3 className="text-cedro-navy mb-6 mt-12">Hoje</h3>
          <p className="mb-5 text-cedro-ink/78">Atendo clinicamente com base em análise existencial e Logoterapia frankliana, integradas a uma antropologia cristã. Meu trabalho se dedica a resolver a desordem interna do cristão, não com contenções superficiais, mas com um caminho real de reconstrução, em três eixos: o comportamental, rotina e disciplina; o emocional e moral responsabilidade e caráter; e o espiritual, identidade e vocação.</p>
          <p className="mb-5 text-cedro-ink/78">Em 2024, fundei a Clínica Cedro - psicologia para cristãos, com psicólogos cristãos. Em pouco mais de um ano, são 7 profissionais e mais de 200 pacientes acompanhados. Cedro não é nome por acaso: raízes profundas, madeira que não apodrece, símbolo bíblico de força e permanência. A Cedro não é uma clínica que aceita cristãos, é uma clínica construída para eles.</p>
          <p className="mb-8 text-cedro-ink/78">Lidero jovens na Igreja Batista Vida Nova. Supervisiono psicólogos. Participei de um painel no Congresso Divinamente e fui convidado do Podcast Divinamente. Palestro em igrejas, empresas e escolas sobre pornografia, identidade, vocação, ansiedade e Logoterapia aplicada. E construí um ecossistema de produtos, do Desafio Pare de lutar contra o pornô à mentoria para pastores e líderes, porque cada pessoa está num momento diferente da jornada, e cada momento exige uma resposta à altura.</p>
          ...
          <div className="flex flex-wrap gap-4 mt-8">
            {[
              ...
              <div key={i} className="px-5 py-2.5 border border-cedro-clay/20 bg-[#f8f4ec] rounded-md text-sm text-cedro-navy">
                {cred}
              </div>
            ))}
          </div>
